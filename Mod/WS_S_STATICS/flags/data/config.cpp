...
class CfgVehicles
{
	...
	class 180_flag_wyvern: 180_flag_base
	{
		...
		class EventHandlers
		{
			init="(_this select 0) setFlagTexture 'WS_S_STATICS\flags\data\180th_Wyvern_Flag.paa'";
		};
	};
	class 180_flag_wyvernDamaged: 180_flag_base
	{
		...
		class EventHandlers
		{
			init="(_this select 0) setFlagTexture 'WS_S_STATICS\flags\data\180th_Wyvern_Flag_D.paa'";
		};
	};
	class Rarefied_Air_Cavalry_Flag: 180_flag_base
	{
		...
		class EventHandlers
		{
			init="(_this select 0) setFlagTexture 'WS_S_STATICS\flags\data\Rarefield_Flag.paa'";
		};
	};
	class Rarefied_Air_Cavalry_Flag_Damaged: 180_flag_base
	{
		...
		class EventHandlers
		{
			init="(_this select 0) setFlagTexture 'WS_S_STATICS\flags\data\Rarefield_Flag_Damaged.paa'";
		};
	};
};
class cfgMods
